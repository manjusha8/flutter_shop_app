...
void main() {
  runApp(new ExpansionTileSampleState());
}

// class ExpansionTileSample extends Stateless {
//   String foos = 'One';
//
//   // static  name= foos;
//
//   // ExpansionTileSample(this.foos);
//
//   @override
    ...
    return new MaterialApp(
      home: new Scaffold(
        ...
        body: new AppExpansionTile(
            key: expansionTile,
            onExpansionChanged: (bool updatedValue) {
              val = foos;
              print('boo val :$updatedValue');
              print('value :$val');
            },
            title: new Text(foos),
  ...
  void _setExpanded(bool isExpanded) {
    ...
    if (_isExpanded != isExpanded) {
      setState(() {
        ...
        if (_isExpanded &&
            ExpansionTileSampleState.val == ExpansionTileSampleState.foos) {
          print('if _isExpanded: $_isExpanded');
          print('inirially expanded: ${widget.initiallyExpanded}');
          print('pagestorage: ${PageStorage.of(context)?.readState(context)}');
          _controller.forward();
        } else {
          print('else _isExpanded: $_isExpanded');
